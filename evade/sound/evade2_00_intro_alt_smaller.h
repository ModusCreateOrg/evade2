...
#define evade2_00_intro_alt_smaller_pattern9_data { \
    ATM_CMD_I_NOTE_C4, \
    ATM_CMD_M_DELAY_TICKS(24), \
    ATM_CMD_I_NOTE_D4_, \
    ATM_CMD_M_DELAY_TICKS(8), \
...
DEFINE_PATTERN(evade2_00_intro_alt_smaller_pattern9_array, evade2_00_intro_alt_smaller_pattern9_data);
    
/* pattern (tune) / "C01|P01" / bytes = 5*/
#define evade2_00_intro_alt_smaller_pattern10_data { \
    ATM_CMD_I_NOTE_G3, \
    ATM_CMD_M_DELAY_TICKS(24), \
    ATM_CMD_I_NOTE_A3_, \
    ATM_CMD_M_DELAY_TICKS(8), \
...
DEFINE_PATTERN(evade2_00_intro_alt_smaller_pattern10_array, evade2_00_intro_alt_smaller_pattern10_data);
    
/* pattern (tune) / "C01|P02" / bytes = 3*/
#define evade2_00_intro_alt_smaller_pattern11_data { \
    ATM_CMD_I_NOTE_OFF, \
    ATM_CMD_M_DELAY_TICKS(32), \
    ATM_CMD_I_RETURN, \
}
DEFINE_PATTERN(evade2_00_intro_alt_smaller_pattern11_array, evade2_00_intro_alt_smaller_pattern11_data);
    
/* pattern (tune) / "C01|P03" / bytes = 13*/
#define evade2_00_intro_alt_smaller_pattern12_data { \
    ATM_CMD_I_NOTE_F3, \
    ATM_CMD_M_DELAY_TICKS(8), \
    ATM_CMD_I_NOTE_G3, \
    ATM_CMD_M_DELAY_TICKS(8), \
...
DEFINE_PATTERN(evade2_00_intro_alt_smaller_pattern12_array, evade2_00_intro_alt_smaller_pattern12_data);
    
/* pattern (tune) / "C03|P00" / bytes = 4*/
#define evade2_00_intro_alt_smaller_pattern13_data { \
    ATM_CMD_M_CALL(4), \
    ATM_CMD_M_DELAY_TICKS(7), \
    ATM_CMD_I_RETURN, \
}
DEFINE_PATTERN(evade2_00_intro_alt_smaller_pattern13_array, evade2_00_intro_alt_smaller_pattern13_data);
...
const PROGMEM struct evade2_00_intro_alt_smaller_score_data {
  ...
  uint8_t evade2_00_intro_alt_smaller_pattern9[sizeof(evade2_00_intro_alt_smaller_pattern9_array)];
  uint8_t evade2_00_intro_alt_smaller_pattern10[sizeof(evade2_00_intro_alt_smaller_pattern10_array)];
  uint8_t evade2_00_intro_alt_smaller_pattern11[sizeof(evade2_00_intro_alt_smaller_pattern11_array)];
  uint8_t evade2_00_intro_alt_smaller_pattern12[sizeof(evade2_00_intro_alt_smaller_pattern12_array)];
  uint8_t evade2_00_intro_alt_smaller_pattern13[sizeof(evade2_00_intro_alt_smaller_pattern13_array)];
  ...
  .patterns_offset = {
      ...
      offsetof(struct evade2_00_intro_alt_smaller_score_data, evade2_00_intro_alt_smaller_pattern9),
      offsetof(struct evade2_00_intro_alt_smaller_score_data, evade2_00_intro_alt_smaller_pattern10),
      offsetof(struct evade2_00_intro_alt_smaller_score_data, evade2_00_intro_alt_smaller_pattern11),
      offsetof(struct evade2_00_intro_alt_smaller_score_data, evade2_00_intro_alt_smaller_pattern12),
      offsetof(struct evade2_00_intro_alt_smaller_score_data, evade2_00_intro_alt_smaller_pattern13),
  },
  .num_channels = 4,
  .start_patterns = {
  ...
  .evade2_00_intro_alt_smaller_pattern9 = evade2_00_intro_alt_smaller_pattern9_data,
  .evade2_00_intro_alt_smaller_pattern10 = evade2_00_intro_alt_smaller_pattern10_data,
  .evade2_00_intro_alt_smaller_pattern11 = evade2_00_intro_alt_smaller_pattern11_data,
  .evade2_00_intro_alt_smaller_pattern12 = evade2_00_intro_alt_smaller_pattern12_data,
  .evade2_00_intro_alt_smaller_pattern13 = evade2_00_intro_alt_smaller_pattern13_data,
};
