...
#define evade2_00_intro_pattern17_data { \
    ATM_CMD_I_NOTE_C3, \
    ATM_CMD_M_DELAY_TICKS(4), \
    ATM_CMD_I_NOTE_OFF, \
    ATM_CMD_M_DELAY_TICKS(2), \
...
DEFINE_PATTERN(evade2_00_intro_pattern17_array, evade2_00_intro_pattern17_data);
    
/* pattern (tune) / "C02|P08" / bytes = 17*/
#define evade2_00_intro_pattern18_data { \
    ATM_CMD_I_NOTE_G2_, \
    ATM_CMD_M_DELAY_TICKS(4), \
    ATM_CMD_I_NOTE_OFF, \
    ATM_CMD_M_DELAY_TICKS(2), \
...
DEFINE_PATTERN(evade2_00_intro_pattern18_array, evade2_00_intro_pattern18_data);
    
/* pattern (tune) / "C02|P09" / bytes = 17*/
#define evade2_00_intro_pattern19_data { \
    ATM_CMD_I_NOTE_A2_, \
    ATM_CMD_M_DELAY_TICKS(4), \
    ATM_CMD_I_NOTE_OFF, \
    ATM_CMD_M_DELAY_TICKS(2), \
...
DEFINE_PATTERN(evade2_00_intro_pattern19_array, evade2_00_intro_pattern19_data);
    
/* pattern (tune) / "C03|P00" / bytes = 7*/
#define evade2_00_intro_pattern20_data { \
    ATM_CMD_M_CALL(4), \
...
DEFINE_PATTERN(evade2_00_intro_pattern20_array, evade2_00_intro_pattern20_data);
    
/* pattern (tune) / "C03|P01" / bytes = 13*/
#define evade2_00_intro_pattern21_data { \
    ATM_CMD_M_CALL(4), \
    ATM_CMD_M_DELAY_TICKS(7), \
    ATM_CMD_M_CALL(4), \
    ATM_CMD_M_DELAY_TICKS(1), \
...
DEFINE_PATTERN(evade2_00_intro_pattern21_array, evade2_00_intro_pattern21_data);
...
const PROGMEM struct evade2_00_intro_score_data {
  ...
  uint8_t evade2_00_intro_pattern17[sizeof(evade2_00_intro_pattern17_array)];
  uint8_t evade2_00_intro_pattern18[sizeof(evade2_00_intro_pattern18_array)];
  uint8_t evade2_00_intro_pattern19[sizeof(evade2_00_intro_pattern19_array)];
  uint8_t evade2_00_intro_pattern20[sizeof(evade2_00_intro_pattern20_array)];
  uint8_t evade2_00_intro_pattern21[sizeof(evade2_00_intro_pattern21_array)];
} evade2_00_intro = {
  ...
  .patterns_offset = {
      ...
      offsetof(struct evade2_00_intro_score_data, evade2_00_intro_pattern17),
      offsetof(struct evade2_00_intro_score_data, evade2_00_intro_pattern18),
      offsetof(struct evade2_00_intro_score_data, evade2_00_intro_pattern19),
      offsetof(struct evade2_00_intro_score_data, evade2_00_intro_pattern20),
      offsetof(struct evade2_00_intro_score_data, evade2_00_intro_pattern21),
  },
  .num_channels = 4,
  .start_patterns = {
  ...
  .evade2_00_intro_pattern17 = evade2_00_intro_pattern17_data,
  .evade2_00_intro_pattern18 = evade2_00_intro_pattern18_data,
  .evade2_00_intro_pattern19 = evade2_00_intro_pattern19_data,
  .evade2_00_intro_pattern20 = evade2_00_intro_pattern20_data,
  .evade2_00_intro_pattern21 = evade2_00_intro_pattern21_data,
};
